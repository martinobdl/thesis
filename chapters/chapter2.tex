...
\begin{definition}\label{eq:ewf}\todo{F: che schifo di definizione. Si}
...
It can be shown \todo{e allora show + cit del toerema} that the algorithm defined by the update rule in Equation \eqref{eq:ewf}, and for a convex loss function $f(\cdot,y_y)$, gives the following guarantee on the regret:
