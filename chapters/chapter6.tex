...
In this section we will discuss some advantages of the OGD algorithm among the algorithm that bound the total regret $R_T^C$ defined in Definition \ref{def:totoal_regret}.
