...
\begin{figure}[ht!]
    \centering
    \subfloat[\label{fig:ex1}]{\includegraphics[width=0.48\textwidth,keepaspectratio]{img/grid_ONS.pdf}}
    \subfloat[\label{fig:ex2}]{\includegraphics[width=0.48\textwidth,keepaspectratio]{img/grid_OLU.pdf}}
